package com.dawes.seguridadModelo;
...
public class UsuarioVO implements UserDetails{
	//Cosa creada en clase sin la colecciones
	/*
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int idusuario;
	
	// los nombre de las variables tienen que tner el mismo nombre que las que recive y maneja el formulario
